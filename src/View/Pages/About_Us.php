...
<section class="about spad">
    <div class="container">
        <div class="about__content">
            <div class="row">
                <div class="col-lg-5" style="border-right: 1px black solid;">
                    <div class="section-title">
                        <h5>Sơ lược về chúng tôi</h5>
                        <h2>Welcome Sun House</h2>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="about__text">
                        <p>Tại Sun House, chúng tôi cam kết mang đến cho bạn một trải nghiệm tuyệt vời, kết hợp giữa sự sang trọng, tiện nghi và dịch vụ chuyên nghiệp.</p>
                        <p>Chúng tôi luôn hướng tới việc cung cấp một không gian nghỉ dưỡng lý tưởng, nơi khách hàng có thể thư giãn,
                            tận hưởng và cảm nhận sự chăm sóc chu đáo
                            Sứ mệnh của chúng tôi là mang đến những khoảnh khắc đáng nhớ, từ những chi tiết nhỏ nhất trong dịch vụ hàng ngày.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="my-5" style="background-image: url(public/images/hero.jpg);">
    <div class="p-5 text-center rounded-3" >
        ...
        <div style="padding: 100px;">
            <div class="section-title">
                <h3 class="text-white fw-bold">Tại Sao Chọn Chúng Tôi</h3>
                <p class="col-lg-8 mx-auto fs-5 text-white">
                    Liên hệ với chúng tôi ngay bây giờ để nhận các ưu đãi mới nhất và cho lần đặt phòng tiếp theo
                </p>
            </div>
            <div>
