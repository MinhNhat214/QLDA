                    ...
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            ...
                            <form action="" method="post">
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <input type="text" name="phone" id="form3Example4cdg" class="form-control form-control-lg" />
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block btn-lg gradient-custom-4 text-body">Register</button>
                                </div>

                                <p class="text-center text-muted mt-5 mb-0">Bạn đã có tài khoản <a href="Login" class="fw-bold text-body"><u>Đăng nhập</u></a></p>
                            </form>
